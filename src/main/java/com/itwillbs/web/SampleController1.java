...
public class SampleController1 {
	...
	// http://localhost:8088/프로젝트명/ (model 1,2)
	// http://localhost:8088/top-level 패키지명/ (spring)
	
	
	// 컨트롤러에서 필요한 동작을 메서드
//	@RequestMapping( value = "매핑할 주소", method = 전달방식(get/post) )
	
	// http://localhost:8088/web/ (프로젝트 시작 주소)
	// http://localhost:8088/web/doA 
	// http://localhost:8088/web/doABC 
	
	// 메세지 파일 [/WEB-INF/views/doA.jsp]을(를) 찾을 수 없습니다.
