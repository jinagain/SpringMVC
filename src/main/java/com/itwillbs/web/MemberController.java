...
public class MemberController {
	...
	public String memberJoinActionPOST(HttpServletRequest request, MemberVO vo) throws Exception {
		// 매개변수 선언(vo) 관련정보(파라메터)자동 수집
		logger.debug(" memberJoinActionPOST() 호출! ");
...
//		return "redirect:/member/login";
	...
	public void infoGET(HttpSession session, Model model) {
		...
		// 회원정보 가져오기 - 아이디정보(세션) DB에 있는 회원정보 모두 조회
		// 서비스 -> DAO
...
//	public String removePOST(MemberVO dvo, HttpSession session) {
	public String removePOST(@SessionAttribute String id, @ModelAttribute("userpw") String userpw, HttpSession session) {
